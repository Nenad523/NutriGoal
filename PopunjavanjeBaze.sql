...
(1, 1),  -- Ovsena kaša sa bananom
(2, 1),  -- Kajgana sa povrćem
(3, 1),  -- Pileća salata
(4, 1),  -- Losos sa brokolijem
(10, 1), -- Pileća prsa sa brokolijem
(11, 1), -- Grčka salata
(12, 1); -- Spanać sa jajetom

-- Izgradnja mišića (CiljId = 2)
INSERT INTO ReceptCiljevi (ReceptId, CiljId) VALUES
(2, 2),  -- Kajgana sa povrćem
(5, 2),  -- Tjestenina sa piletinom
(6, 2),  -- Grilovana govedina sa krompirom
(7, 2),  -- Pileća supa
(8, 2),  -- Riža sa povrćem
(9, 2),  -- Pečeni losos sa rižom
(14, 2); -- Banana shake

-- Održavanje (CiljId = 3)
INSERT INTO ReceptCiljevi (ReceptId, CiljId) VALUES
(1, 3),  -- Ovsena kaša sa bananom
(3, 3),  -- Pileća salata
(4, 3),  -- Losos sa brokolijem
(9, 3),  -- Pečeni losos sa rižom
(13, 3), -- Jogurt sa orasima
(15, 3); -- Avokado tost

INSERT INTO ReceptSastojci (ReceptId, SastojakId, KolicinaG) VALUES
-- Ovsena kaša sa bananom (ReceptId = 1)
(1, 17, 100.00),  -- Ovsena kaša 100g
(1, 18, 120.00),  -- Banana 120g
(1, 5, 200.00),   -- Mlijeko 200g

-- Kajgana sa povrćem (ReceptId = 2)
(2, 4, 150.00),   -- Jaja 150g
(2, 13, 100.00),  -- Paradajz 100g
(2, 12, 50.00),   -- Spanać 50g
(2, 16, 10.00),   -- Maslinovo ulje 10g

-- Pileća salata (ReceptId = 3)
(3, 1, 200.00),   -- Pileća prsa 200g
(3, 13, 100.00),  -- Paradajz 100g
(3, 14, 100.00),  -- Krastavac 100g
(3, 16, 15.00),   -- Maslinovo ulje 15g

-- Losos sa brokolijem (ReceptId = 4)
(4, 3, 200.00),   -- Losos 200g
(4, 11, 150.00),  -- Brokoli 150g
(4, 16, 10.00),   -- Maslinovo ulje 10g

-- Tjestenina sa piletinom (ReceptId = 5)
(5, 9, 200.00),   -- Tjestenina 200g
(5, 1, 150.00),   -- Pileća prsa 150g
(5, 16, 10.00),   -- Maslinovo ulje 10g

-- Grilovana govedina sa krompirom (ReceptId = 6)
(6, 2, 250.00),   -- Govedina 250g
(6, 10, 200.00),  -- Krompir 200g
(6, 16, 10.00),   -- Maslinovo ulje 10g

-- Pileća supa (ReceptId = 7)
(7, 1, 300.00),   -- Pileća prsa 300g
(7, 11, 100.00),  -- Brokoli 100g
(7, 14, 100.00),  -- Krastavac 100g

-- Riža sa povrćem (ReceptId = 8)
(8, 8, 200.00),   -- Riža 200g
(8, 11, 100.00),  -- Brokoli 100g
(8, 13, 100.00),  -- Paradajz 100g
(8, 16, 10.00),   -- Maslinovo ulje 10g

-- Pečeni losos sa rižom (ReceptId = 9)
(9, 3, 200.00),   -- Losos 200g
(9, 8, 150.00),   -- Riža 150g
(9, 16, 10.00),   -- Maslinovo ulje 10g

-- Pileća prsa sa brokolijem (ReceptId = 10)
(10, 1, 250.00),  -- Pileća prsa 250g
(10, 11, 200.00), -- Brokoli 200g
(10, 16, 10.00),  -- Maslinovo ulje 10g

-- Grčka salata (ReceptId = 11)
(11, 13, 150.00), -- Paradajz 150g
(11, 14, 150.00), -- Krastavac 150g
(11, 7, 100.00),  -- Sir 100g
(11, 16, 15.00),  -- Maslinovo ulje 15g

-- Spanać sa jajetom (ReceptId = 12)
(12, 12, 200.00), -- Spanać 200g
(12, 4, 100.00),  -- Jaja 100g
(12, 16, 10.00),  -- Maslinovo ulje 10g

-- Jogurt sa orasima (ReceptId = 13)
(13, 6, 200.00),  -- Jogurt 200g
(13, 20, 30.00),  -- Orasi 30g

-- Banana shake (ReceptId = 14)
(14, 18, 150.00), -- Banana 150g
(14, 5, 250.00),  -- Mlijeko 250g

-- Avokado tost (ReceptId = 15)
(15, 15, 100.00), -- Avokado 100g
(15, 13, 50.00),  -- Paradajz 50g
(15, 16, 10.00);  -- Maslinovo ulje 10g

SELECT Id, Naziv, Kalorije, Proteini FROM Recepti